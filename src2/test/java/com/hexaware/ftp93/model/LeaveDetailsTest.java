 ...
 */
 ...
 /**
  ...
  public final void testapplyProcess(@Mocked final LeaveDetailsDAO dao) throws ParseException {
    ...
    {
      {
        dao.insert(3001, 2, "2018-12-19", "2018-12-20", "EL", "function", "2018-12-10");
      }
    };
    new MockUp<LeaveDetails>()
    {
    ...
    assertEquals(exp, act);
    String actual = LeaveDetails.applyProcess(1000, "2018-12-24", "2018-12-25", "EL", "function");
    String expec =  "**** Your leave request succcessfully recored " + "form :" + "2018-12-24"
                + " - " + "2018-12-25" + " for: " + 2 + "days" + " ****";
 ...
 /**
  ...
  public final void testMgrComments(@Mocked final LeaveDetailsDAO dao) throws ParseException {
    ...
    final LeaveDetails ld = new LeaveDetails(2000, 100, 2, sd.parse("2018-12-08"), sd.parse("2018-12-09"), LeaveType.EL,
        LeaveStatus.DENIED, "fever", sd.parse("2018-12-05"), "approve");
    final LeaveDetails ld2 = new LeaveDetails(2000, 100, 2, sd.parse("2018-12-08"), sd.parse("2018-12-09"),
        LeaveType.EL, LeaveStatus.APPROVED, "fever", sd.parse("2018-12-05"), "approve");
    final LeaveDetails ld3 = new LeaveDetails(2000, 100, 2, sd.parse("2018-12-08"), sd.parse("2018-12-09"),
        LeaveType.EL, LeaveStatus.APPROVED, "fever", sd.parse("2018-12-05"), "approve");
    new Expectations() {
      {
        dao.findLeave(100);
    ...
    String act = LeaveDetails.managerAction(2000, 100, "APPROVED", "approve");
    String exc = "Approved Successfully";
    assertEquals(exc, act);
    String act1 = LeaveDetails.managerAction(2000, 100, "DENIED", "approve");
    String exc1 = "Denied Permission";
    assertEquals(exc1, act1);
    String act2 = LeaveDetails.managerAction(3000, 100, "DENIED", "approve");
    String exc2 = "You are not authorized!!";
    assertEquals(exc2, act2);
    String act3 = LeaveDetails.managerAction(2000, 100, "APPROVED", "approve");
